...
use st_domain::{FleetDecisionFacts, NavStatus, Ship, WaypointSymbol};
...
#[server]
async fn get_fleet_decision_facts() -> Result<FleetDecisionFacts, ServerFnError> {
