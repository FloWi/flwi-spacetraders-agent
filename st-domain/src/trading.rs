...
pub fn find_trading_opportunities(market_data: &[(WaypointSymbol, Vec<MarketTradeGood>)], waypoints: &[Waypoint]) -> Vec<TradingOpportunity> {
        ...
        .flat_map(|(export_wp, export_mtg)| {
            imports
                ...
                .filter(move |(import_wp, import_mtg)| {
                    export_wp != import_wp && export_mtg.symbol == import_mtg.symbol && export_mtg.purchase_price < import_mtg.sell_price
                })
